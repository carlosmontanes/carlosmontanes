videojs.registerPlugin('passwordToView', function(pluginOptions) {
  ...
  newElement.innerHTML = '<div><img class="bcls-image" src="https://plumbr.io/app/uploads/2015/01/thread-lock.jpeg"><br><input class="theForm" type="password" id="passwordInputID"><br><input id="formButtonID" class="theForm" type="submit" value="Sign In"></div>';
